...
function c(p, e) {
  return n(), t("svg", s, e[0] || (e[0] = [
    r("path", { d: `M16,31.36C7.53,31.36,0.64,24.47,0.64,16S7.53,0.64,16,0.64S31.36,7.53,31.36,16S24.47,31.36,16,31.36z
	...
	v9.792l6.748,3.896L22.748,20.312z` }, null, -1)
  ]));
}
const w = /* @__PURE__ */ o(l, [["render", c]]);
export {
  w as default
};
